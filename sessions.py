    ...
    def compute_features(self, df: pd.DataFrame, tf: str) -> pd.DataFrame:
        ...
        def add_feature(df, name, timeframe):
            feature_lookup = {
                ...
                'weighted_50_bull_doji': {'call': features.doji, 'params': (df, 0.5, 2, True)},
                'weighted_50_bear_doji': {'call': features.doji, 'params': (df, 0.5, 2, True)},
                'weighted_100_bull_doji': {'call': features.doji, 'params': (df, 1, 2, True)},
                'weighted_100_bear_doji': {'call': features.doji, 'params': (df, 1, 2, True)},
                'weighted_150_bull_doji': {'call': features.doji, 'params': (df, 1.5, 2, True)},
                'weighted_150_bear_doji': {'call': features.doji, 'params': (df, 1.5, 2, True)},
                'un_weighted_bull_doji': {'call': features.doji, 'params': (df, 0.5, 2, False)},
                'un_weighted_bear_doji': {'call': features.doji, 'params': (df, 0.5, 2, False)},
